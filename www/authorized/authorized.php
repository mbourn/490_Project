...
<main>
  ...
  <div id="get_multi_div">
    <section id="get_multi_expl">
      ...
      If you would like to create multiple vCards, but not the whole set, click here:
      <button onclick="window.location=href='https://mbourn.com/multi_vcard.php?id=multi'">Continue</button>
    </section>
  </div>
